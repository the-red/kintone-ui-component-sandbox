...
let exportCheckbox;
(() => {
    exportCheckbox = window.customElements.get("kuc-checkbox-1-6-0");
    if (exportCheckbox) {
        return;
    }
  ...
  `;
    ...
    ], KucCheckbox.prototype, "className", void 0);
    __decorate([
        property({ type: String })
    ], KucCheckbox.prototype, "error", void 0);
    __decorate([
        property({ type: String, reflect: true, attribute: "id" })
    ], KucCheckbox.prototype, "id", void 0);
    __decorate([
        property({ type: String })
    ], KucCheckbox.prototype, "itemLayout", void 0);
    __decorate([
        property({ type: String })
    ], KucCheckbox.prototype, "label", void 0);
    __decorate([
        property({ type: Boolean })
    ], KucCheckbox.prototype, "borderVisible", void 0);
    __decorate([
        property({ type: Boolean })
    ], KucCheckbox.prototype, "disabled", void 0);
    __decorate([
        property({ type: Boolean })
    ], KucCheckbox.prototype, "requiredIcon", void 0);
    __decorate([
        property({
            type: Boolean,
            attribute: "hidden",
    ...
    ], KucCheckbox.prototype, "visible", void 0);
    __decorate([
        property({ type: Array })
    ], KucCheckbox.prototype, "items", void 0);
    __decorate([
        property({ type: Array })
    ], KucCheckbox.prototype, "selectedIndex", void 0);
    __decorate([
        property({ type: Array })
    ], KucCheckbox.prototype, "value", void 0);
    __decorate([
        queryAll(".kuc-checkbox-1-6-0__group__select-menu__item__input")
    ], KucCheckbox.prototype, "_inputEls", void 0);
    __decorate([
        state()
    ], KucCheckbox.prototype, "_valueMapping", void 0);
    window.customElements.define("kuc-checkbox-1-6-0", KucCheckbox);
    createStyleOnHeader(CHECKBOX_CSS);
    exportCheckbox = KucCheckbox;
})();
const Checkbox = exportCheckbox;
export { Checkbox };
