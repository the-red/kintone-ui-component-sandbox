...
(() => {
    exportMobileCheckbox = window.customElements.get("kuc-mobile-checkbox-1-6-0");
    if (exportMobileCheckbox) {
        return;
    }
    class KucMobileCheckbox extends KucBase {
        constructor(props) {
            super();
            this.className = "";
            this.error = "";
       ...
       <svg
         ...
         xml:space="preserve">
         <image width="44" height="34" x="0" y="0" href="${this._getSVGStrokeValue(checked)}"/>
      </svg>
       `;
        }
      ...
      `;
        ...
        <fieldset class="kuc-mobile-checkbox-1-6-0__group">
          ...
          <div
            class="kuc-mobile-checkbox-1-6-0__group__select-menu ${this.requiredIcon
                ? "kuc-mobile-checkbox-1-6-0__group__select-menu--required"
                : ""}"
            ?borderVisible="${this.borderVisible}"
            ?disabled="${this.disabled}"
          >
    ...
    ], KucMobileCheckbox.prototype, "className", void 0);
    __decorate([
        property({ type: String })
    ], KucMobileCheckbox.prototype, "error", void 0);
    __decorate([
        property({ type: String, reflect: true, attribute: "id" })
    ], KucMobileCheckbox.prototype, "id", void 0);
    __decorate([
        property({ type: String })
    ], KucMobileCheckbox.prototype, "label", void 0);
    __decorate([
        property({ type: Boolean })
    ], KucMobileCheckbox.prototype, "borderVisible", void 0);
    __decorate([
        property({ type: Boolean })
    ], KucMobileCheckbox.prototype, "disabled", void 0);
    __decorate([
        property({ type: Boolean })
    ], KucMobileCheckbox.prototype, "requiredIcon", void 0);
    __decorate([
        property({
            type: Boolean,
            attribute: "hidden",
    ...
    ], KucMobileCheckbox.prototype, "visible", void 0);
    __decorate([
        property({ type: Array })
    ], KucMobileCheckbox.prototype, "items", void 0);
    __decorate([
        property({ type: Array })
    ], KucMobileCheckbox.prototype, "selectedIndex", void 0);
    __decorate([
        property({ type: Array })
    ], KucMobileCheckbox.prototype, "value", void 0);
    __decorate([
        queryAll(".kuc-mobile-checkbox-1-6-0__group__select-menu__item__input")
    ], KucMobileCheckbox.prototype, "_inputEls", void 0);
    __decorate([
        state()
    ], KucMobileCheckbox.prototype, "_valueMapping", void 0);
    window.customElements.define("kuc-mobile-checkbox-1-6-0", KucMobileCheckbox);
    createStyleOnHeader(MOBILE_CHECKBOX_CSS);
    exportMobileCheckbox = KucMobileCheckbox;
})();
const MobileCheckbox = exportMobileCheckbox;
