...
let exportDialog;
(() => {
    exportDialog = window.customElements.get("kuc-dialog-1-6-0");
    if (exportDialog) {
        return;
    }
    class KucDialog extends KucBase {
        ...
        _handleFocusFirstDummy() {
            const lastFocusableElement = this._focusableElements[this._focusableElements.length - 2];
            lastFocusableElement && lastFocusableElement.focus();
        }
        _handleFocusLastDummy() {
            this._dialogEl.focus();
        }
        _handleKeyDownDialog(event) {
            if (event.key === "Escape") {
    ...
    ], KucDialog.prototype, "icon", void 0);
    __decorate([
        property({ type: String })
    ], KucDialog.prototype, "title", void 0);
    __decorate([
        property()
    ], KucDialog.prototype, "content", void 0);
    __decorate([
        property()
    ], KucDialog.prototype, "footer", void 0);
    __decorate([
        query(".kuc-dialog-1-6-0__dialog")
    ], KucDialog.prototype, "_dialogEl", void 0);
    __decorate([
    ...
    ], KucDialog.prototype, "_focusableElements", void 0);
    window.customElements.define("kuc-dialog-1-6-0", KucDialog);
