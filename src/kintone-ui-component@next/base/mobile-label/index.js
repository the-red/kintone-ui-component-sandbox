...
export class BaseMobileLabel extends KucBase {
    ...
    _getTextTemplate() {
        return this.guid && this.guid !== ""
          ...
          >
        `
            : html ` <span class="kuc-base-mobile-label-1-6-0__text">${this.text}</span> `;
    }
}
__decorate([
...
if (!window.customElements.get("kuc-base-mobile-label-1-6-0")) {
    createStyleOnHeader(BASE_MOBILE_LABEL_CSS);
    window.customElements.define("kuc-base-mobile-label-1-6-0", BaseMobileLabel);
}
